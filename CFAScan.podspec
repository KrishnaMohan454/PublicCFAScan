...
Pod::Spec.new do |s|
  s.name             = 'CFAScan'
  s.version          = '0.1.0'
  s.summary          = 'A short description of CFAScan.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/KrishnaMohan454/CFAScan'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'KrishnaMohan454' => 'krishnamohan@authenticid.co' }
  s.source           = { :git => 'https://github.com/KrishnaMohan454/CFAScan.git', :tag => s.version.to_s }
